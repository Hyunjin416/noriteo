...
export default function CommentForm({ boardId, onSuccess, editTarget = null, onCancel, currentUser, parentId = null }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (editTarget) {
                await axios.put(`/api/comments/${editTarget.commentId}`, { content }); /* 예시 api */
                alert("댓글이 수정되었습니다.");
            if (onCancel) onCancel();
            } 
            else {
                await axios.post("/api/comments", { /* 예시 api */
                    boardId,
